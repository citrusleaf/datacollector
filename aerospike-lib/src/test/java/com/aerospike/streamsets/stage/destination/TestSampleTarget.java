 ...
 */
package com.aerospike.streamsets.stage.destination;

import com.streamsets.pipeline.stage.destination.aerospike.AerospikeDTarget;
...
public class TestSampleTarget {
  ...
  public void testWriteSingleRecord() throws Exception {
    TargetRunner runner = new TargetRunner.Builder(AerospikeDTarget.class)
